...
public class GameLoadingStage : FiaGUILayer
{
	public static GameLoadingStage Instance
	{
		get
		{
			return GameLoadingStage.instance_;
		}
		set
		{
			GameLoadingStage.instance_ = value;
		}
	}

	private void Awake()
	{
		GameLoadingStage.Instance = this;
	}
	...
	protected override void Start()
	{
		...
		base.StartCoroutine(this.LoadGameStage());
	}
	...
	public override void DoInit()
	{
		...
		this.image_ = instance.CreateByWindowSpace(num, array, fiaTexture, 1, new Vector3(2f, 2f, 16f));
	...
	private IEnumerator LoadGameStage()
	{
		...
		{
			Debug.Log(KartManager.Instance.parameter_.Stage);
		}

...
public class GUITutorial2 : FiaGUILayer
{
	public GUITutorial2()
	{
	...
	public override void DoInit()
	{
		...
		int num = 0;
		float[] array = new float[] { 0f, 0f, 0f, 0f, 260f, 208f, 345f, 209f };
		...
		float[] array2 = new float[] { 120f, 222f, 682f, 310f, 2f, 542f, 564f, 630f };
	...
	protected override void AfterPanelUpdate()
	{
		...
		if (this.mouseManager_.IsSelected())
		{
			...
			if (selectedKey == 0)
			{
				...
				KartOptions.Instance.SetQuestFlag(KartOptions.QuestFlag.TUTORIAL2, true);
	...
	public override void ReceiveMessage(int sender, MonoBehaviourMessage msg)
	{
		...
		if (msg.type_ == MonoBehaviourMessageType.SHOW_TUTORIAL2 && !base.gameObject.active)
		{
	...
	private float[][] PANEL_INFO = new float[][] { new float[] { 120f, 101f, 566f, 412f, 1016f, 525f } };
